...
class cnn_feedforward_div_norm(nn.Module):
    ...
    def __init__(self, t_steps):
        ...
        self.sconv1 = module_div_norm(32, 24, 24, init[0], True, init[0], True, init[0], True)
        
        # conv2
        self.conv2 = nn.Conv2d(in_channels=32, out_channels=32, kernel_size=5)
        self.sconv2 = module_div_norm(32, 8, 8, init[1], True, init[1], True, init[1], True)

        # conv3
        self.conv3 = nn.Conv2d(in_channels=32, out_channels=32, kernel_size=3)
        self.sconv3 = module_div_norm(32, 2, 2, init[2], True, init[2], True, init[2], True)
 
        # fc 1
        self.fc1 = nn.Linear(in_features=128, out_features=1024)
        self.sfc1 = module_div_norm('none', 'none', 1024, init[3], True, init[3], True, init[3], True)
    ...
    def reset_parameters(self, K_init, train_K, alpha_init, train_alpha, sigma_init, train_sigma):
        ...
        self.sfc1.K = nn.Parameter(K_init[3], requires_grad=False)
